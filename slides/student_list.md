...
A two-sided matching problem in which market allocates students to colleges (Hoxby 1997, 2009)
...
-   "Inquiries" (student as first contact)
    ...
    -   Enrollment problem: Cannot survive/thrive solely from students who reach out on their own
...
"Student list" products: a matchmaking intermediary that connects institutions to prospects

-   Third-party vendors obtain data and contact info about prospecs (e.g., Testing orgs, search engines)
-   Sell contact information of prospects to colleges looking for students
...
-   Problem with student list products
...
-   Problem with utilization of student list products by administrators
    -   May choose combinations of search filters that results in racial exclusion

<br>

Research questions

1.  What is the relationship between search filters and the racial composition of included versus excluded students?
2.  To what extent do we observe patterns of student list purchases that utilize racialized inputs in concert with other search filters?
3.  What is observed racial composition of student list purchases that utilize racialized inputs in concert with other search filters?
...
1.  What is the relationship between search filters and the racial composition of included versus excluded students?
    - Reconstruct College Board student list product using nationally representative sample of 9th graders from 2009 (NCES HSLS data)
...
Selection devices: procedures/routines for allocating individuals to categories based on set of input factors (Hirschman and Bosk, 2020)

- Descretionary selection devices
  - Decisions incorporate judgment of individual evaluators (e.g., holistic admissions)
- Standardized selection devices
  - decisions based on a mathematical function in which value of input variables determines value of outcome
  - "actuarial" selection devices: predictions based on analysis of past cases
  - non-actuarial (e.g., U. Michigan admissions pre-2003)
...
<img src="assets/fig/rq2-counts-1.png" alt="plot of chunk rq2-counts" width="90%" />
...
<img src="assets/fig/rq2-race-research-1.png" alt="plot of chunk rq2-race-research" width="90%" />
...
<img src="assets/fig/rq2-income-research-1.png" alt="plot of chunk rq2-income-research" width="90%" />
...
<img src="assets/fig/rq2-locale-research-1.png" alt="plot of chunk rq2-locale-research" width="90%" />
...
<img src="assets/fig/rq2-race-regional-1.png" alt="plot of chunk rq2-race-regional" width="90%" />
...
<img src="assets/fig/rq2-income-regional-1.png" alt="plot of chunk rq2-income-regional" width="90%" />
...
<img src="assets/fig/rq2-locale-regional-1.png" alt="plot of chunk rq2-locale-regional" width="90%" />
...
O. Jaquette, K. G. Salazar, and P. Martin.
