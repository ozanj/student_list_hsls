...
bind_cols(
  ...
  kable(
    ...
    align = rep(c('l', 'c', 'c'), 2),
    caption = "Table 1: Top filter combinations used in College Board orders purchased purchased by research vs. master's"
  ) %>%
...
(For Online Version)
```{r order-filters-empirical-report, fig.height = 5, fig.cap = "Figure 3: Filters used in College Board Orders Purchased by 14 Public Universities"}
orders_filters %>% 
