...
**Author response**: We acknowledge that the manuscript was previously too long and appreciate the editor's very helpful suggestions for trimming to the EEPA submission guidelines. Per recommendations, we have moved figures 1, 2, 4, and 8 into the supplemental online appendix. While we believe it was important to keep Figure 13 in the main manuscript, we have have alternatively moved Table 1 to online appendices to shorten the length of tables and figures. We have also trimmed back the first two paragraphs of the results section as suggested. Although several editor/reviewer suggestions (below) prompted us to add more text, we sought to balance these additions by thoroughly shaving text throughout the manuscript.

The previous manuscript contained 41 pages of text (not including title, abstract, or references), 2 tables, and 13 figures. Assuming one page per table and figure. This is a total of 41+2+13 = 56 pages.

The new manuscript contains 40 pages of text (not including title, abstract, or references), 1 table, and 9 figures for a total of 50 pages. Assuming one page per table and figure, this is a total of 40+1+9 = 50 pages.
...
We added three paragraphs to the end of the introduction (p. 4):
...
**Author response**: All of these copy edits and suggestions have been incorporated into the revised manuscript. The carnegie classification explanation is now footnoted in the data sub-section for Table S2. Additionally, we will be creating a public git repository with all scripts needed to replicate HSLS09 analyses.
...
**Author response**: We revised text to state more clearly that colleges would still have an incentive to be selective about which prospects receive marketing materials that cost money and to respond to Reviewer 1's concern about standardized tests. The revised text is as follows (p. 37):
...
**Author response**: We have added a bit more specificity, stating that (pp. 36-37):
...
**Author response**: We apologize for these smaller points that added to Reviewer 1's confusion. We have clarified and revised all of these accordingly in the manuscript. This includes reducing the number of "vis-a-vis" phrases in the manuscript to two usages and Reviewer 1's suggested edits to Table 1, which has now been moved into the online appendix for space considerations. 
...
**Author response**: Reviewer 3 makes two excellent suggestions here. We believe that both suggestions can be addressed by adding text about institutional practices to the "Policy Implications" section. Here is the text we added (pp. 38-39):
