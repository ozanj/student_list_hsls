...
Racial inequality in college access remains an enduring barrier to social mobility. The share of White and Asian students who attend college remains greater than the share of Black and Hispanic who attend college [@Baker2018]. Based on the High School Longitudinal Survey of 2009, about 83% of Asian, 72% of White, 63% of Hispanic, and 62% of Black students enrolled in college within a year and a half of graduating high school in 2013 [@RN2010]. For students who attend college, college selectivity is a strong predictor of outcomes such as degree completion [@RN2045], initial job market participation [@Long2008], earnings growth over time [@MacLeod2017], and ability to repay student loans [@Jackson2013]. However, Black and Hispanic students are also substantially less likely to attend selective colleges than White and Asian students [@RN2517; @RN1749]. Moreover, the disproportionate impact of COVID19 on Black and Hispanic students has worsened racial disparities in college access [@RN2046].  
...
The second data source consists of "order summaries" and their resulting "student lists" for College Board purchases by 14 public universities. Table \@ref(tab:sampletable) in the supplemental online appendix shows selected characteristics for the universities in our data collection sample. This [link](https://drive.google.com/file/d/1wUd_tf-drCsFEaDGjZV3sdBRboo4QPjo/view?usp=sharing) shows an example of a College Board summary for a student list purchase. Order summaries were collected as part of a larger project by issuing public records requests to all public universities in five states (CA, IL, TX, MN, and one anonymous state) about student lists purchased from 2016-2020. Order summaries from 830 student lists purchased by 14 universities were used to analyze RQ2, which asks which search filters did public universities utilize?
...
RQ2 asks which search filters did public universities utilize. <!--Analyses draw on order summaries for the 830 student list purchases across the 14 universities in our public records request data collection.  --> We use counts and proportions of filters used across research (N=8) versus ma/doctoral (N=6) universities to describe patterns in how racialized search filters are used alongside other filters when purchasing lists.
