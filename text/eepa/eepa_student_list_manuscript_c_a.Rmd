...
After the creation of Title IV federal financial aid programs, US higher education finance can be conceived as a national voucher system, whereby tuition revenue -- including household savings and financial aid -- follows students to the institution they enroll in. Most colleges cannot thrive solely from prospective students who reach out on their own [@RN3625]. Rather, colleges must find desirable prospects who can be convinced to apply and enroll. In 1972 the College Board began selling lists of prospective students to colleges [@belkin2019-studata], enabling colleges to identify and target desirable students across the country.
...
Our conceptual framework and analyses have broader implications for critical scholarship on education policy. Structural theories of inequality conceive of progressive policies to overcome racial inequality as sitting atop structurally racist systems. @RN4814[p. 476] writes that “the only way to ‘cure’ society of racism is by eliminating its systemic roots.” We argue that critical policy research should go on the offensive by naming and interrogating seemingly neutral or objective racialized structures that contribute to the broader structurally racist system of educational opportunity. This article offers student list products as an exemplar racialized structure. Even as conservative courts dismantle racially progressive education policies, we assert that critical analyses of structural racism are likely to influence court decisions because analyses can show how particular products or practices systematically treat people unequally based on race.

Given the proliferation of software-as-service (SaS) products in education, we argue that third-party products should become the object of critical policy research. Many of these products can be usefully conceptualized as selection devices in that they target individuals for some intervention based on a set of inputs. Discretionary selection devices, such as student list products, give administrators discretion over which filters are utilized to target individuals. In standardized selection devices (e.g., identifying "at risk" students), the relationship between the value of input variables and the outcome is dictated by an algorithm. Whether it is standardized or discretionary, the sociology of race literature suggests that a selection device that utilizes racialized inputs will yield racially inequality [@RN4786; @RN4778; @RN4883]. Unfortunately, education policy research seldom focuses on products as the object of inquiry. Individual products may be similar to federal and state policies in terms of the scale of students they affect. For example, more than 10 million U.S. k-12 students reportedly utilize _Naviance_ college planning software [@powerschool], while the Intersect recruiting platform enables colleges to target Naviance users. As third-party products increasingly perform core functions on behalf of schools and colleges [@RN4843], structural inequality embedded in product design may drive structural inequality in educational opportunity. Federal laws grant regulatory agencies substantial authority to regulate consumer products. Therefore, critical analyses of third-party products can inform regulations that reduce racial disparities in education.
