...
The second data source consists of "order summaries" and their resulting "student lists" for College Board purchases by 14 public universities. Table \@ref(tab:sampletable) in the supplemental online appendix shows selected characteristics for the universities in our data collection sample.^[Table \@ref(tab:sampletable) uses Carnegie 2020 Basic classification to collapse institutions into two institution types. All doctoral universities with highest or high research activity were categorized as "Research Universities. Master's universities across all programs were categorized as "Master's Universities".] This [link](https://drive.google.com/file/d/1wUd_tf-drCsFEaDGjZV3sdBRboo4QPjo/view?usp=sharing) shows an example of a College Board summary for a student list purchase. Order summaries were collected as part of a larger project by issuing public records requests to all public universities in five states (CA, IL, TX, MN, and one anonymous state) about student lists purchased from 2016-2020. Order summaries from 830 student lists purchased by 14 universities were used to analyze RQ2, which asks which search filters did public universities utilize?
...
RQ2 asks which search filters did public universities utilize. <!--Analyses draw on order summaries for the 830 student list purchases across the 14 universities in our public records request data collection.  --> We use counts and proportions of filters used across research (N=9) versus master's (N=5) universities to describe patterns in how racialized search filters are used alongside other filters when purchasing lists.
...
\begingroup
\fontsize{8}{8}\selectfont
NOTE: One research university placed a large amount of orders, which influenced the overall filters used for all research universities. The contribution of this particular university is shown in the darker teal color in the figure.
\endgroup




```{r orders-sat, fig.height = 3, fig.cap = "SAT Filter Used by Research vs. Master's Public Universities"}
