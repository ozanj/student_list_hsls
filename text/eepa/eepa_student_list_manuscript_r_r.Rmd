...
- THE MARKET FOR COLLEGE ACCESS BY HOXBY
  - INFORMATION ASSYMETRY; COLLEGES DON'T KNOW WHO THE DESIRABLE STUDENTS ARE, WHERE THEY ARE, OR HOW TO CONTACT THEM
  - COLLEGES CAN'T SURVIVE/THRIVE BASED SOLELY ON INQUIRIES/APPLICANTS THAT REACH OUT ON THEIR OWN
  - HOXBY SAID THAT SAT CREATES A NATIONAL HIGHER EDUCATION MARKET BY LOWERING COST OF INFORMATION ABOUT STUDENTS (THEIR ACHIEVEMENT/APTITUDE)
  - STUDENTS COULD SEND SCORES TO SCHOOLS THEY WERE INTERESTED IN
  - IN 1972, CB BEGAN CB SEARCH PRODUCT THAT ENABLES COLLEGES TO PURCHASE CONTACT INFO OF STUDENTS THAT MEET DESIRED CRITERIA, PARTICULARLY TEST SCORE RANGES
- ORIGINS OF CONSUMER REPORTS HAVE STRIKING SIMILARITIES
  - SMALL BANKS BECOME LARGER BANKS; WANT TO GO FROM A MODEL OF PASSIVELY EVALUATING CUSTOMERS TO ACTIVELY TARGETING DESIRABLE OF PRE-APPROVED CUSTOMERS
  
- BUT WHILE CONSUMER REPORTS REGULATED BY CFRA AND CFPB, STUDENT LISTS NOT
  - CONSUMER REPORTS MUST SHOW THAT THEY DO NOT DO X ABOUT RACE
- SO STUDENT LISTS PRODUCTSW ARE UNREGULATED
  - AND TRANSITION TO THE IDEA THAT THEY USE INPUTS CORRELATED WITH RACE SO THEY MAY BE SYSTEMATICALLY LOWERING OPPORTUNITY FOR STUDENTS FROM COMMUNITIES OF COLOR RELATIVE TO OTHERS
  - AND SAY THAT THEY ARE LIKELY TO BE USED IN WAYS THAT CAUSE HARM
  - MOTIVATE ANALYSES AND BOOM!
