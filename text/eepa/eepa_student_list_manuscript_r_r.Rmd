...
This manuscript focuses on search filters from the College Board Student Search Service that we conceptualize as racialized inputs [@RN4786]. We address three research questions. First, What is relationship between search filters and racial composition of included vs excluded students? Second, how do public universities use racialized input search filters in concert with other search filters when purchasing student lists? Third, what is observed racial composition of student list purchases that utilize racialized input search filters in concert with other search filters? We address RQ1 by reconstructing the College Board Student Search Service product using a nationally representative sample of 9th graders in 2009 from the High School Longitudinal Survey (HSLS:09). Analyses simulate and compare the racial composition of included versus excluded prospects when certain search filters are utilized. We address RQ2 and RQ3 by analyzing 830 student lists purchased by 14 public universities, which were collected via public records requests.
...
Enrollment management is the organizational behavior side of college access and student success. The term enrollment management can refer simultaneously to a profession, an administrative structure, and an industry. As a profession, enrollment management integrates techniques from marketing and economics in order to help universities realize enrollment goals by “influenc[ing] the characteristics and the size of enrolled student bodies” [@RN2771, p. xiv]. Universities must enroll students to survive and thrive. Beyond the basic goal of survival, universities pursue some combination of broad enrollment goals (e.g., tuition revenue, academic profile, racial diversity) [@RN2247]; @RN1549], while also meeting the needs of various campus constituencies (e.g., College of Engineering needs majors, athletic teams need players) [@RN4321; @RN3519]. As an administrative structure, the office of enrollment management typically controls the activities of admissions, financial aid, and marketing and recruiting [@RN2772]. The broader enrollment management industry consists of university professionals (e.g., vice president for enrollment management, admissions counselors), professional associations (e.g., National Association for College Admission Counseling), and third-party vendors/consultancies that interact with universities and students (e.g., College Board, EAB, PowerSchool).
...
Universities cannot realize their enrollment goals solely from prospects who find the university on their own. They must incite demand and discover desirable prospects who can be convinced to apply and enroll. The “enrollment funnel” -- depicted in Figure \@ref(fig:em-funnel) -- is  a conceptual model used by enrollment management industry to visualize broad stages in the process of recruiting students. The funnel begins with a large pool of "prospects" (i.e., prospective students) that the university would like to convert into enrolled students. "Leads" are prospects whose contact information (or "profiles") has been purchased. "Inquiries" are prospects that contact your institution and consist of two types: first, inquiries who respond to an initial solicitation  (e.g., email) from the university; and second, "student-as-first-contact" inquiries who reach out to the university on their own (e.g., sending ACT scores). Applicants consist of inquiries who apply plus "stealth applicants" who do not contact the university before applying. The funnel narrows at each successive stage in order to convey the assumption of "melt" at each stage (e.g., a subset of "inquiries" will apply).

Practically, the purpose of the enrollment funnel is to inform recruiting interventions that target one or more stage. These interventions seek to increase the probability of "conversion" across stages [@RN4322]. At the top of the enrollment funnel, colleges identify undergraduate leads primarily by buying student lists [@RN4895]. Virtual tours and digital display ads solicit student-as-first-contact inquiries [CITE]. The sum of purchased leads plus student-as-first-contact inquiries constitutes the set of all prospects the university has contact information for who may receive subsequent targeted recruiting interventions. At the bottom of the funnel, financial aid packages [e.g., @RN3133] and yield recruitment events [CITE] are used to convert admits to enrolled students. 
...
Cottom's [-@cottom2017lower] ethnography of enrollment management shows that for-profits found a niche in Black and Latinx communities precisely because traditional colleges ignored these communities. The for-profit business model of encouraging students to take on federal and private loans exemplifies “predatory inclusion,” the logic of "including marginalized consumer-citizens into ostensibly democratizing mobility schemes on extractive terms" [@RN4774, p. 443]. Another example is "payday loans" that target people with low credit scores based on data purchased from credit bureaus [@RN4810]. @cottom2017lower shows that for-profits identify and target prospects by compiling and purchasing lists, but they did not rely on lists from College Board and ACT because their target audience of Black and Latinx adult women were recent test-takers. Ironically, Black and Latinx adult women were vulnerable to marketing from for-profits because they were excluded from the College Board and ACT lists used by traditional colleges.
<!-- 
...
Scholarship on recruiting from sociology assumes that recruiting is something done by individual colleges, ignoring third-party products and vendors that colleges rely on. A small number of studies from economics analyze how students respond to interventions delivered by third-party products [e.g.] [@RN4894; @RN4901], but no studies analyze third-party recruiting products as the fundamental object of analysis. We argue that third-party products and vendors structure college recruiting behavior and, in turn, college access. Interestingly, studies across economics and sociology tend find that underrepresented minority students are particularly sensitive to recruiting interventions. However, we do not know how third-party recruiting products incorporate structural inequality, whether the product architecture systematically disadvantages underrepresented students of color, and we do not know how colleges utilize these products. This study deconstructs the College Board Search product. Conceptually, we examine whether the product relies on "racialized inputs" [@RN4786] that are associated with structural racial inequality. We simulate the usage of these inputs using nationally representative data and then we examine the usage of these inputs in actual student lists purchased by public universities.

## Background: Student List Products

**List-based vs. behavioral-based leads**. “Lead generation” is the process of connecting merchants who sell products to "leads" -- consumers potentially interested in these products [@ftc2016]. Student lists and consumer credit data sold by credit bureaus like Equifax are examples of "list-based" lead generation. List-based lead generation is based on the direct mail business model [@singer1988] but has evolved into "database marketing," in which prospects in a database of customers are selected based on some set of filter criteria. Advances in digital technology yielded behavioral-based targeting, which includes most advertising on websites and social media. Whereas list-based marketing proceeds in two steps -– obtain customer contact information and then serve marketing material –- behavioral-based targeting identifies targets based on their user profile and simultaneously serves advertisements to users while they are on the platform.

An article on digital advertising by the enrollment consultancy @RN4728 provides insight the usage of list-based and behavioral-based leads in higher education (p. 9):
...
When recruiting college-going high school students, @RN4728 suggests that behavioral-based leads are less effective than purchasing names from College Board/ACT and then targeting these prospects on digital platforms (e.g., Meta allows colleges to serve ads to purchased names on Facebook/Instagram). By contrast, behavioral-based targeting (e.g., Google Ags, Google Display Network, Twitter) is the primary sources of lead generation when high-quality databases of prospective customers are not available. Therefore, online programs, vocational programs, and programs targeting working adults (e.g., at community colleges and for-profits) often rely on behavioral-based targeting [@RN4897].

**Sources of student list data**. Student list data are extracted from the user-data of students laboring on platforms (e.g., taking a test, searching for college). Historically, the student list business has been dominated by College Board and ACT, which derive student list data from their database of test-takers. In the 21st Century, advances in technology yielded new sources of student list data, particularly free online college search engines (e.g., Cappex) and college planning software sold to high schools used by high school students and guidance counselors (e.g., Naviance, Scoir) [@list_biz]. The test-optional movement and growth in the number of high schools using college planning software threaten the competitive advantage of College Board and ACT in the domain of coverage.

**Who buys student lists**. Knowledge about which colleges use student lists relies substantially on market research by consulting firms. In particular, Ruffalo Noel Levitz publishes regular reports about recruiting practices based on survey responses from their clients, which tend to be public and private non-profit universities of mid-level size and mid-level selectivity. In an analysis of 120 4-year colleges (78 private, 42 public), @RN4895 reported that 87% of private and 86% of public institutions "purchase high school student names to generate inquiries and applicants" (p. 5).^[16% of private colleges purchased fewer than 50,000 names annually, 35% purchased 50-100K, 28% purchased 100-150K, and 21% purchased more than 150K names annually]. For public institutions, 20% purchased fewer than 50,000 names annually, 29% purchased 50-100K, 31% purchased 100-150K, and 20% purchased more than 150K names annually. Reporting by @belkin2019-studata and data collection by @list_biz suggest that larger and more selective institutions purchase more names than smaller and less selective ones. @RN4896 reports that purchasing names was the top ranked expenditure item in the undergraduate marketing and recruiting budget for both private and public institutions. In 2022 the the average public institution allocated 15% of its budget to purchasing names -- up from 12% in 2020. By contrast, the average public institution spent 2% of its budget on behavioral-based lead generation.^[In 2022 the average private institution allocated 16% of its budget to purchasing names -- up from 14% in 2020. By contrast, behavioral-based lead generation for accounted for 7% of the 2022 budget.]

**How lists are used**. Student lists are arguably the most fundamental input in the process of recruiting undergraduate students. At the top of the enrollment funnel (Figure \@ref(fig:em-funnel)), colleges buy the contact information of prospects they want to recruit. These purchased leads -- along with behavioral based leads (e.g., click a display add) and inquiries who reach out on their own (e.g., take a virtual tour) -- are then delivered recruiting interventions designed to push them to subsequent stages of the funnel. Of the institutions that purchase names, nearly all purchase names of 11th graders and 12th graders, while 85% of privates and 78% of publics purchase names of 10th graders [@RN4895]. @RN4895[p. 6] reports that email, targeted digital advertising (e.g., Instagram), and direct mail are the top three "preferred methods for first\ldots contact with high school purchased names" and that the average number of times purchased names are contacted before giving up is 11 for private institutions and 8 for public institutions. 

Much like the role of voter files in political campaigns [@RN4731], purchased lists are the basic building block for data-informed "recruiting campaigns." Enrollment management offices – and the consulting firms they hire – use predictive models to inform recruiting interventions.^[Anecdotal evidence suggests that the majority of 4-year colleges hire an enrollment management consulting firm for the purpose of recruiting [@list_empirics] [CITE ANOTHER]. Collectively, the largest two firms -- Ruffalo Noel Levitz and EAB -- claim to provide enrollment management services (recruiting, financial aid, student success, development) to more than 3,000 colleges in the U.S. [@eabcomm; @rnlabout]. Purchasing names on behalf of the college is a core service consultancies provide and many firms have developed predictive models to inform name buys [@fire_engine_red_search_modeling; ruffalo_noel_levitz_2021]] However, both the algorithms and the interventions must be fed data about prospects (e.g., cannot send brochures and emails without addresses). Each list purchased from College Board ([see template](https://drive.google.com/file/d/1Qvc_QRi9izEF1W78Lh4nNi5NsXjCZqUE/view)) or ACT ([see template](https://drive.google.com/file/d/1rsP45OyOsnPYhV8uWYKDAy_spGhjj6aj/view)) is essentially a spreadsheet with one row per prospect and columns for contact information and student characteristics from the pre-test questionnaire (e.g., graduation year, high school code, gender, ethnicity, race, first-generation status, intended major). Once purchased, student lists are layered with additional data sources, such as consumer data about prospects from credit companies, records of interactions with prospects (e.g., visiting virtual tour), historical application/enrollment data about students who attended the same high school, etc. These layered data are the input to predictive models that inform decisions about which recruiting interventions to send to which prospects (e.g., who gets a \$0.50 postcard and who gets a \$7 brochure).

With respect to efficacy, @RN4402 asked clients to rate different "first contact" interventions (e.g., off-campus recruiting visit) as sources of inquiries and enrolled students. For the median public college, purchased lists accounted for 26\% of inquiries, which ranked \#1, and accounted for 14\% of enrolled students, which ranked fourth after "application as first contact" (19\%), campus visit (17\%), and off-campus visit (16\%). For the median private college, student list purchases were the highest source of inquiries, accounting for 32\% of inquiries and were tied with off-campus recruiting visits as the highest source of enrolled students, accounting for 18\% of enrolled students. With respect to efficacy from the perspective of students, @RN4739 compared SAT test-takers who opted into the College Board Student Search Service -- allowing accredited institutions to "licence" their contact information -- to those who opted out. After controlling for covariates (e.g., SAT score, parental education), 41.1\% of students who participated in Search attended a 4-year college compared to 32.8\% of students who opted out, an 8.3 percentage point difference and a 25.3 (`(41.1-32.8)/32.8`) percent change in the relative probability. Participating in Search was associated with a larger change in the relative probability of attending a 4-year college for Black students (24.5\%) and Hispanic student (34.4\%) than White students (21.6\%), and a larger change for students whose parents did not attend college (40.6\%) than those whose parents had a BA (18.9\%). Additionally, where students start college affects the probability of graduation [@RN2261; @RN1494]. After controlling for covariates, @RN4739 find that 20.6\% of students who participated in Search obtained a BA in four years compared to 15.7\% of students who opted out, representing a 31.2\% increase in the relative probability of graduation and this increase was larger for Black (40.3\%) and Latinx (43.3\%) students (48.3\%) than it was for white students and larger for students whose parents did not attend college (50.0\%) than it was for students whose parents had a BA (25.3\%).


**Buying College Board and ACT student lists**. Each student list purchase selects a subset of prospects from a larger, underlying database of prospects. Student list products incorporate search filters that allow customers to control which prospect profiles they select. Here, we focus on buying lists from College Board, but ACT products are quite similar, and other products -- such as *Intersect*, which allows colleges to target *Naviance* users -- also incorporate search filters [@markup_naviance]. 

@list_empirics categorizes search filters available in the College Board Student Search Service product into the four buckets of academic, geographic, demographic, and student preferences (e.g., desired campus size, intended major). Academic filters include high school graduating class, SAT score, PSAT score, AP score by subject, high school GPA, and high school class rank. Individual filters are specified as score ranges (e.g., XXX - XXX) and can be combined with other filters as `AND` or `OR` conditions. Geographic search filters include state, CBSA, county, zip code, "geomarket," and "geodemographic" filters. Most geographic filters are based on existing borders, but the geomarket and geodemographic filters create new borders based on proprietary College Board data about college enrollment for previous cohorts. Demographic filters include race, ethnicity, gender, and first-generation status. Student preference filters include intended major, college size, and college type (e.g., XXXXXXX).

At minimum, most student list purchases filter on high school graduating class, at least one academic filter, and at least one geographic filter [@list_empirics]. Filtering on multiple search filters facilitates precise targeting of prospects. As in political advertising [@RN4789], micro-targeting has become a branding strategy for student list products. For example, College Board Student Search promises to “create a real pipeline of best-fit prospects” @RN1623 while ACT Encoura uses the tag-line “find and engage your best-fit students” @RN1624. Consulting firms encourage universities to execute multiple student list purchases, each targeting different market segments [e.g., @waxman]. For example, in data collected by [@list_empirics], colleges assigned names to individual searches, such as, "Women in STEM," "International 2022 PSAT 1200," "CA 2021 SAT URM to 1290," "Performing arts," etc. Given that College Board lists contain minimal data about academic achievement, several enrollment management consultants (speaking to us on background) reported purchasing many lists with incrementally varying achievement filters in order to infer academic achievement.
...
Selection devices that utilize geography as a predictive input were pioneered within geodemography, a branch of market research that estimates the behavior of consumers based on where they live [@RN4880; @RN4878]. Initially, geodemographic systems scored individual localities (e.g., zip code) based on consumer behavior. Subsequent geodemographic classification systems (e.g., Mosaic by Experian) classify localities and individuals into like audience segments for marketers [[CITE](https://www.experian.com/content/dam/marketing/na/assets/ems/marketing-services/documents/product-sheets/mosaic-product-sheet.pdf)]. The article *Exploiting Marketing Opportunities* by Richard [@RN4886] -- director of Experian Marketing Services UK and creator of Acorn and Mosiac -- states:

> Geographical information can\ldots be very useful at the recruitment stage. Addresses in postcodes with high levels of bad debt can be eliminated as can those where credit referencing activity is particularly low. Area classification systems, such as Mosaic and Acorn, yield further discriminators which can be used to reduce the recruitment of poor credit risks\ldots The combination of all this information into a recruitment scorecard allows the credit operator to select the best possible addresses from rented lists, electoral rolls or the company's own customer file\ldots and enables the recruitment of accounts to be redirected away from areas of high bad debt [@RN4886, p. 36].^[Quote taken from @RN4880[p. 447]]

**_Predictive analytics inputs_**. Predictive analytics are another class of racialized inputs in selection devices. Predictive analytics are often used to predict outcomes for new cases based on analysis of previous cases. For example, predictive models of recidivism identify the determinants of recidivism for past cases and apply these results to predict the probability of recidivism for new cases @RN4849. Ex-offenders with high predicted probabilities of recidivism receive greater police attention, which increases the probability of arrest. @RN4794[p. 224] state that “predicting the future on the basis of the past threatens to reify and reproduce existing inequalities of treatment by institutions." @RN4887 refers to this phenomenon as the "ratchet effect," whereby disproportionately targeted populations are predicted to have higher risk of an outcome, which amplifies disproportionate targeting. Predictive analytics can also be used as an input. For example, geodemographic methods create geographic customer segments based on past consumer data and use these segments as one input to select target customers [@RN4565; @RN4744]. The @RN4743 warns that using historical data to predict the behavior of a new group of people "creates new justifications for exclusion" (p. 10).

## Student List Products

RQ1 is about structural racial inequality embedded in the underlying architecture of student list products

**Test-taking and test score filters**. Holding aside for now exclusion emerging from how individual utilize student lists, we argue that student list products themselves produce structural inequality in two broad ways. The first source of structural inequality in student list products is which prospective students are included in the underlying database. For any selection device or statistical model, when individuals are excluded from an analysis sample because they have missing values for some or all variables, the possibility of selection bias emerges. If missingness is correlated with race, then the selection device yields systematic racial exclusion. Guidance from the Federal Trade Commission states that "If a data set is missing information from particular populations, using that data to build an AI model may yield results that are unfair or inequitable to legally protected groups" [@RN4749].
...
MAKE A SIGN-POST TO READER THAT THIS IS ABOUT RQ2 AND RQ3; IDEAS ABOUT "COMBINATIONS OF FILTERS" FROM END OF THE "PRODUCTS" SECTION GET MOVED INTO UTILIZATION SECTION

Individual administrators executing student list purchases may exercise discretion over which search filters and filter thresholds to select and how many purchases to execute. We briefly highlight key ideas that emerge sociological scholarship on product utilization. First, On balance, scholarship finds that discretionary selection devices increase structural inequality compared to standardized selection devices [CITE] [@RN4883; @RN4881; @RN4795]. Second, Discretionary selection devices allow the explicit or implicit racial bias of individual decision-makers to affect selection decisions [@RN4794; @RN4801]. Third, Americans drastically underestimate the magnitude of racial income inequality [@RN4884], and this "racial ignorance reinforces white domination" [@RN4885, p. 142]. In turn, discretionary selection devices that incorporate racialized inputs are likely to amplify racial inequality because individual decision-makers may view racialized inputs as objective measures of merit [@RN4882; @RN4866] and/or decision-makers may be ignorant about how selection inputs interact with on-the-ground patterns of racial inequality [@RN4801]. Finally, transparency -- decisions about selection criteria clear to all stakeholders -- and accountability -- consequences for utilizing bias selection criteria -- are necessary conditions to prevent ascriptive bias in discretionary selection processes [@RN4881; @RN4883].

Drawing from the utilization literature, we raise three ideas about the relationship between administrative discretion and racial inequality in student list purchases. First, universities likely select academic achievement filters that are consistent with admissions standards. Although race-based differences in test-taking and test scores may be driven by structural inequality, most admissions offices over the last 50 years viewed test scores as objective measures of achievement or aptitude [@RN3699]. Therefore, we expect more selective institutions are more likely to filter on standardized test scores and are likely to select higher test score filters compared to less selective institutions.

Second, some colleges may utilize discretion offered by student list products to explicitly target underrepresented populations. Indeed, College Board and ACT products are designed to facilitate this goal because colleges may filter by race, ethnicity, gender, first-generation status, and XXXXX. 

- can purchase lists for URM at lower test score thresholds than lists purchased for white and asian.
- But this can be done in ways that include or exclude students from communities of color

Third, student list products are designed to facilitate micro-targeting of "best fit" prospects but using multiple filters to precisly target prospects may interact with local patterns of racial segregation in ways that are difficult to predict. Therefore, we expect that using multiple academic filters to precisely target prospects and/or using multiple academic filters combined w/ geographic filters

- So, when we see purchases that combine multiple academic filters 
- and/or purchases that include w/ complicated geographic filters,  these purchases may yield pronounced racial inequality



Therefore, to the extent that the admissions office 

In order for discret

On balance, empirical scholarship on product utilization tends to find that discretion increases racial inequality. 


This individual administrative discretion may reduce or amplify structural inequality embedded in student list products.

The "utilization" literature tends to find that discretion increases inequality, but certain conditions may reduce or amplify inequality [CITE]. @RN4794 state that many industries adopted standardized selection devices because of concern about bias and inconsistency by individual decision-makers. Scholarship more supportive of discretion suggests that professionals may reduce inequality by exercising discretion with respect to professional norms [@RN4778] [CITE ANOTHER]. University admissions standards likely influence decisions about student list purchases, suggesting that racial equality or inequality in student list purchases is a function of university admissions standards. However, an audit experiment by @RN4720 finds that white admissions counselors exhibit racial bias when evaluating prospective students. Furthermore, student lists may be purchased by any individual associated with a Title IV institution, including third-party enrollment management consultants. The enrollment management profession is oriented towards maximizing enrollment goals [@RN3625], which may conflict with the goal of equality of opportunity.^[For instance, the enrollment goal of racial diversity may be pursued without adhering to racial equality in who has an opportunity to enroll.] 

@RN4883 and @RN4881 find that both transparency and accountability -- consequences for not meeting standards -- are necessary conditions to prevent ascriptive bias in discretionary selection processes. Student list purchases are not transparent to university stakeholders or the general public. Standards about student list purchases do not exist and neither do accountability mechanisms. 

Americans drastically underestimate the magnitude of racial income inequality [@RN4884]. Furthermore, @RN4801 shows that the presence of racialized inputs (i.e., structural racism) amplifes racial inequality in discretionary selection processes that is due to individual bias or individual ignorance about racial inequality. Student list products are complex, powerful discretionary selection devices explicitly designed to facilitate micro-targeting through the use of multiple search filters. These search filters interract with local patterns of racial segregation that are difficult to predict unless the purchaser has substantial knowledge about the local area. Overall, student list products utilize racialized inputs while provide administrative discretion to individuals who may not be professionals and may be uninformed about patterns of racial inequality. Therefore, we suggest that discretion may amplify racial inequality when student list purchases simultaneousluy utilize multiple search filters that include racialized inputs.. [REVISE LAST SENTENCE]
