...
```{r gpa-sat-psat, echo = FALSE, fig.align = 'center', fig.cap = "Academic Combinations: GPA (3.0+) and College Entrance or Pre-Entrance Exams (across score thresholds)", out.width = "49%", fig.show='hold'}
#knitr::include_graphics('./../../outputs/images/enrollment_funnel.png')
...
```{r gpa-sat-psat-zip, echo = FALSE, fig.align = 'center', fig.cap = "Academic and Geographic Combination: GPA (3.0+), College Pre-Entrance (150+) or Entrance (1050+) Exams, and Zip (across income thresholds)", out.width = "49%", fig.show='hold'}
