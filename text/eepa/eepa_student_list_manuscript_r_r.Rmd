...
Scholarship on recruiting from economics tends to analyze the causal effect of specific recruiting interventions on subsequent student behavior [e.g.] [@RN4341]. @RN3699 evaluate an experiment that delivered customized information about admissions and financial aid to high-achieving, low-income students. The intervention positively affected applications, admission, and enrollment to selective colleges. These results catalyzed subsequent scholarship on information and advising interventions [e.g.] [@RN4900; @RN4352; @RN4345], but results have been mixed. Leveraging a natural experiment in College Board student lists, @RN4894 found that the purchase of a prospect profile by a university increases the probability that the prospect will apply and enroll at the university, with larger effects sizes for traditionally underserved students. Another set of studies evaluate interventions by flagship public universities that combine outreach and aid [@RN4850; @RN4408]. 
...
<!-- For-profit colleges utilized student lists to target prospects, but these lists were generally not purchased from College Board or ACT because their target population of Black and Latinx adult women were mostly not recent SAT/ACT test-takers [@cottom2017lower].--> 
