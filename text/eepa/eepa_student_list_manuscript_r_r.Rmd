...
Most scholarship on the enrollment management behavior of universities focuses on the latter stages of the enrollment funnel, particularly the process of deciding which applicants to admit [e.g.] [@RN4131; @RN3522; @RN4135] and the use of financial aid to convert admits to enrolled students [@RN1948; @RN2241; @RN3762]. Fewer studies investigate the earlier "recruiting" stages of identifying prospects, acquiring leads, and soliciting inquiries and applications.

Scholarship on recruiting from economics tends to analyze the causal effect of specific recruiting interventions on subsequent student behavior [@@RN4341]. @RN3699 evaluate a randomized control trial intervention that delivered customized information about admissions and financial aid to high-achieving, low-income students, finding positive effects on application, admission, and enrollment behavior. These results catalyzed subsequent scholarship on information and advising interventions [e.g.] [@RN4900; @RN4352; @RN4345], but results have been mixed. Other studies investigate the effect of interventions by individual universities that combine outreach and aid [@RN4850; @RN4408]. Leveraging a natural experiment in College Board student lists, @RN4894 found that the purchase of a prospect profile by a university increases the probability that the prospect will apply and enroll at the university, with larger effects sizes for traditionally underserved students.



@RN3699 evaluate the application, admission, and enrollment effects of a randomized control intervention that delivered customized information about admissions and financial aid to high-achieving, low-income students. 

- Hoxby: information interventions
- Smith article about lists
