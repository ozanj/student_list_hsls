...
P1: racial inequality in college access remains an enduring barrier to social mobility [CITE; CHETTY?].
...
<!-- INTRODUCTION, ORIGINAL SUBMISSION
...
Enrollment management is the organizational behavior side of college access and student success. The term enrollment management can refer simultaneously to a profession, an administrative structure, and an industry. The enrollment management profession integrates techniques from marketing and economics in order to help universities realize enrollment goals by “influenc[ing] the characteristics and the size of enrolled student bodies” [@RN2771, p. xiv]. As an administrative structure, the office of enrollment management coordinates -- and typically controls -- the activities of admissions, financial aid, and marketing and recruiting [@RN2772]. The broader enrollment management industry consists of university professionals (e.g., vice president for enrollment management, admissions counselors), professional associations (e.g., National Association for College Admission Counseling), and third-party vendors and consultancies that interact with universities and students (e.g., College Board, EAB, Ruffalo Noel Levitz, PowerSchool).
...
Practically, the purpose of the enrollment funnel is to inform recruiting interventions that target one or more stage. These interventions seek to increase the probability of "conversion" across stages [@RN4322]. At the top of the enrollment funnel, public and private non-profit universities identify undergraduate leads primarily by buying student lists [@RN4895]. Virtual tours and digital display ads solicit student-as-first-contact inquiries [CITE]. The sum of purchased leads plus student-as-first-contact inquiries constitutes the set of all prospects the university has contact information for who may receive subsequent targeted recruiting interventions. Off-campus recruiting visits solicit inquiries and applications [CITE]. At the bottom of the funnel, financial aid packages [e.g., @RN3133] and yield recruitment events [CITE] are used to convert admits to enrolled students. 
...
@RN4728 argues that list-based leads are more effective than behavioral-based leads when high-quality databases of prospective customers are available. For example, Meta allows advertisers to serve ads directly to purchased names who are Facebook or Instagram users. When recruiting college-going high school students, @RN4728 suggests that behavioral-based leads are less effective than purchasing names from College Board/ACT and targeting these prospects on Meta platforms. By contrast, behavioral-based targeting (e.g., Google Ags, Google Display Network, Twitter) is the primary sources of lead generation when high-quality databases of prospective customers are not available. Therefore, online programs, vocational programs, and programs targeting working adults (e.g., at community colleges and for-profits) often rely on behavioral-based targeting [@RN4897].
...
**Who buys student lists**. Knowledge about which colleges use student lists relies substantially on market research by consulting firms. Ruffalo Noel Levitz publishes regular reports about recruiting practices based on survey responses from their clients, which tend to be public and private non-profit universities of mid-level size and mid-level selectivity. In analysis of 120 4-year colleges (78 private, 42 public), @RN4895 reported that 87% of private and 86% of public institutions "purchase high school student names to generate inquiries and applicants" (p. 5). 16% of private colleges purchased fewer than 50,000 names annually, 35% purchased 50-100K, 28% purchased 100-150K, and 21% purchased more than 150K names annually. For public institutions, 20% purchased fewer than 50,000 names annually, 29% purchased 50-100K, 31% purchased 100-150K, and 20% purchased more than 150K names annually. Reporting by @belkin2019-studata and data collection by @list_biz suggest that larger and more selective institutions purchase more names than smaller and less selective ones. @RN4896 reports that purchasing names was the top ranked expenditure item in the undergraduate marketing and recruiting budget for both private and public institutions. In 2022 the average private institution allocated 16% of its budget to purchasing names -- up from 14% in 2020 -- and the avarage public institution allocated 15% of its budget to purchasing names -- up from 12% in 2020.

START HERE THURSDAY


For the median public university, purchased lists accounted for 26\% of inquiries, which ranked \#1, and accounted for 14\% of enrolled students, which ranked fourth after "application as first contact" (19\%), campus visit (17\%), and off-campus visit (16\%).^[For private non-profit institutions, 34\% of private institutions purchased fewer than 50,000 names, 24\% purchased 50,000-100,000 names, 23\% purchased 100,000-150,000 names, and 18\% purchased more than 150,000 names [@RN4741]. Additionally, student list purchases were the highest source of inquiries, accounting for 32\% of inquiries and were tied with off-campus recruiting visits as the highest source of enrolled students, accounting for 18\% of enrolled students [@RN4402].]
Reporting by XXX and data collected by XXX suggest that larger and more selective institutions purchase more names than smaller 

**How lists are used**. TEXT

**Buying College Board and ACT student lists**. TEXT

**Who buys student lists**. TEXT

Knowledge about student list products relies substantially on the "grey literature" of market research and promotional publications written by vendors and consultancies in the EM industry. 


PUT THIS IN BACKGROUND SECTION
Student lists are an example of list-based "lead generation" based on the direct mail model, in contrast to behavioral-based leads, such as advertisements from Google Search or the Google Display Network. An article on digital advertising by the consultancy @RN4728, states that 

> For industries outside of higher education and for nonfreshman recruitment, a primary aim of digital marketing is often that of identifying a pool of potentially interested customers. . . [By contrast] Where the recruitment of college-bound high school students is concerned, digital channels are less important from a lead-generation perspective, because the vast majority of likely candidates are already readily identifiable via testing and survey services (ACT, College Board, etc.)


# Background: Student List Products (original submission)
...
-->
ADD STEPHANIE CELLINI SCHOLARSHIP ON ADVERTISING SOMEWHERE IN THIS LIT REVIEW, BUT BRIEFLY: https://www.brookings.edu/research/commercials-for-college-advertising-in-higher-education/ 

- https://www.brookings.edu/wp-content/uploads/2020/05/Commercials-for-college_Appendix.pdf
