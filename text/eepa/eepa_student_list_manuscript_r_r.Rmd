...
Collected as part of a larger project [@list_empirics], the second data source consists of "order summaries" and their resulting "student lists" for College Board purchases by 14 universities. These data are used in analyses for RQ2 and RQ3. As described in @list_empirics, we collected these data by issuing public records requests to all public universities in five states (CA, IL, TX, MN, and one anonymous state) about student lists purchased from 2016-2020. @list_empirics analyzed 830 College Board orders by 14 universities, which yielded more than 3.6 million prospect profiles. Figure \@ref(fig:order-filters-empirical-report) shows the filters utilized in these orders.   
