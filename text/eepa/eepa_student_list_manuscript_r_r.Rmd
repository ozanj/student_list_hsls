...
Cottom's [-@cottom2017lower] ethnography of enrollment management shows that for-profits found a niche in Black and Latinx communities precisely because traditional colleges ignored these communities (see also @dache2018dangling). The for-profit business model of encouraging students to take on federal and private loans exemplifies "predatory inclusion," the logic of "including marginalized consumer-citizens into ostensibly democratizing mobility schemes on extractive terms" [@RN4774, p. 443]. Another example is "payday loans" that target people with low credit scores based on data purchased from credit bureaus [@RN4810]. @cottom2017lower shows that for-profits identify and target prospects by compiling and purchasing lists, but they did not rely on lists from College Board and ACT because their target audience of Black and Latinx adult women were recent test-takers. Ironically, Black and Latinx adult women were vulnerable to marketing from for-profits because they were excluded from the College Board and ACT lists used by traditional colleges.
<!-- 
...
Reflecting on the recruiting literature, scholarship from sociology assumes that recruiting is something done by individual colleges, ignoring third-party products and vendors that colleges rely on. In economics, a small number of studies analyze how students respond to interventions delivered by third-party products [e.g.] [@RN4894; @RN4901], but no studies analyze third-party recruiting products as the fundamental object of analysis (although see @RN4904 analysis of advertising spend by colleges). We argue that third-party products and vendors structure college recruiting behavior and, in turn, college access. Interestingly, studies across economics and sociology tend find that underrepresented minority students are particularly sensitive to recruiting interventions. However, we do not know how third-party recruiting products incorporate structural inequality, whether the product architecture systematically disadvantages underrepresented students of color, and we do not know how colleges utilize these products. This study deconstructs the College Board Search product. Conceptually, we examine whether the product relies on "racialized inputs" [@RN4786] that are associated with structural racial inequality. We simulate the usage of these inputs using nationally representative data and then we examine the usage of these inputs in actual student lists purchased by public universities.
...
Using data about 830 student lists purchased by 14 public universities, @list_empirics found that the average list specified `r avg_criteria` criteria and `r pct_purchase`% of purchases simultaneously specified at least one academic and one geographic filter. Filtering on multiple search filters facilitates precise targeting of prospects. Consulting firms encourage universities to execute multiple student list purchases, each targeting different market segments [e.g., @waxman]. For example, in data collected by [@list_empirics], colleges assigned names to individual searches, such as, "Women in STEM," "International 2022 PSAT 1200," "CA 2021 SAT URM to 1290," "Performing arts," etc. 
<!-- 
