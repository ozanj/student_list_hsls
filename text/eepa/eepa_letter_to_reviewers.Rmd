...
- RQ3 motivates analyses of the racial composition of targeted student list purchases -- motivated by the conceptual framework -- that filter on multiple search criteria. 
  ...
  - [KARINA -- ADD A FEW SENTENCES ABOUT WHAT ANALYSES RUN AND THE CONTRIBUTION]
...
> **Reviewer 1 concern**. *Products like the College Board’s search tool are blunt and imperfect and, as you demonstrate, likely problematic and exclusionary. But therearen’t many alternatives. What would an ideal tool look like that allows colleges to find students (affluent and otherwise) that have a reasonablelikelihood of being admitted to the institution?*
...
**Author response**. We agree with these concerns and have made all requested cuts, except that the revised conceptual framework is not shorter because we added text about how colleges utilize student lists in response to Editor/Reviewer concerns. Here is a list of cuts made from the original manuscript:
...
- Figures removed or moved to appendix
  - Removed Figure 1 (a reproduction of other scholars' work)
  - KARINA LIST ALL FIGURES REMOVED OR MOVED TO APPENDIX
...
**Author response**. KARINA - YOU WRITE THIS ONE
...
**Author response**: KARINA - REVISE THE METHODS SECTION AND RESPOND TO CONCERN
...
**Author response**: KARINA - SEE WHAT THEY ARE GETTING AT AND ANSWER THE UNDERLYING QUESTION. AND THEN SAY WHY WE EXCLUDED THIS ANALYSIS 
...
**Author response**: We agree that this distinction is important. We have fixed instances of failing to make this distinction. KARINA - MAKE SURE MANUSCRIPT DOESN'T DO THIS.
...
**Author response**: The revised manuscript introduces an alternative student list product based on data from state longitudinal data systems. @list_policy describes this proposal in greater detail. Briefly, contact information and academic achievement information about all prospects who opted in would be available to eligible colleges for free. As such, there would be no need to filter prospects prior to obtaining the lists. After obtaining the lists, the college could decide which prospects receive which recruiting interventions.
...
**Author response**: KARINA -- HANDLE THIS. THE THEIR UNDERLYING CONCERN IS IFTHE FUNNEL IS SOMETHING WE MADE UP OR IF IT IS A REAL THING THAT EXISTS IN THE WORLD. SO CITE SOME ORIGINAL SOURCE, AND INDICATE THAT WE JUST CHANGED THE COLORS OR SOMETHING LIKE THAT.
...
**Author response**. Thank you for this suggestion! We agree with Reviewer 3 that framing the manuscript vis-a-vis racial inequality in college access helpls situate the so-what of studying student lists. In the revised manuscript, the first paragraph focuses on racial inequality in college access and provides statistics based on [KARINA]. The introduction then shows that the emergence of student lists was fundamentally based on the standardized college entrance exam, which sociologists argue are mechanisms that amplify historic structural inequality. Additionally, we begin the discussion section re-stating the problem of racial inequality in college access. 
...
**Author response**. KARINA -- CAN YOU HANDLE THIS ONE; THE VIANO AND BAKER ARTICLE IS ABOUT HOW RACE AND ETHNICITY ARE CONSTRUCTED WHEN WORKING W/ ADMIN DATA https://journals.sagepub.com/doi/epub/10.3102/0091732X20903321 ; YOU COULD INSERT THIS CITATION IN THE DATA/VARIABLES PART OR LIMITATIONS PART TO SAY ABOUT HOW WE CREATED THE MEASURE OF RACE/ETHNCITY AND HOW IT CREATES A SINGLE VARIABLE FROM TWO SEPARATE VARAIABLES OF RACE AND ETHNICITY. SOME STATEMENT ABOUT HOW THIS REDUCES NUMMBER OF STUDENTS WHO IDENTIFY AS RACE/ETHNICITY X, Y, Z. AND THEN SAY, WE CHOOSE NOT TO INCORPORATE THIS LITERATURE INTO A DISCUSSION OF CRITICAL DATA STUDIES BECAUSE WE HAVE LARGELY REMOVED CRITICAL DATA STUDIES FROM THE MANUSCRIPT DUE TO CONCERNS ABOUT LENGTH AND SCOPE.
