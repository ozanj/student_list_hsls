...
The result is a manuscript that we feel is dramatically improved. We are extremely grateful for the effort in care you have given to help improve this manuscript and to help us develop as scholars. The original submission was 36 pages of text and 15 pages of tables/figures (not including references). The revised manuscript is 41 pages of text and 12 pages of tables/figures (not including references). We believe the addition of length is warranted by the additional issues that the Editor/Reviewers asked the manuscript to address.
